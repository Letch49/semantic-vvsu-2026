...
В данной задаче вам предстоит выполнить лингвистический анализ текстовых данных с использованием библиотек для синтаксического разбора (`natasha`, `spacy` или `nltk`) и морфологического анализа (`pymorphy` или `spacy`). 
...
- Для морфологического анализа:
  - `pymorphy` - для русского языка (морфологический анализ)
...
- [Документация PyMorphy](https://pymorphy2.readthedocs.io/) - для русского языка
